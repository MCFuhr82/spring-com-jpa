...
public class TestConfig implements CommandLineRunner { //CommandLineRunner indica que quando iniciar a aplicação, essa classe será rodada, através do método run
    ...
    public void run(String... args) throws Exception {
        ...
        Order order1 = new Order(null, Instant.parse("2022-01-30T20:02:33Z"), user1);
        Order order2 = new Order(null, Instant.parse("2022-02-01T10:05:33Z"), user2);
        Order order3 = new Order(null, Instant.parse("2022-02-01T10:10:45Z"), user1);
